...
import tensorflow_io as tfio  # Ensure TensorFlow-IO is imported
import tensorflow as tf

parser = argparse.ArgumentParser(description="Generate sharded dataset from original MOVI data.")
parser.add_argument(
