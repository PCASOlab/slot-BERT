...
Output_root = Output_root+ "MLP_dynamic_slots_2" + dataset_tag + str(Data_percentage) + "/"
...
DEFAULT_CONFIG = "videosaur_m/configs/videosaur/ytvis3_MLP_ds_xtend.yml"
...
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),GPU_mode,num_gpus,Using_contrast=False,Using_SP_regu = True,Using_SP = True,Using_slot_bert=False,slot_ini= "rnn",cTemp=1.1,gpu_selection=Gpu_selection,pooling="max",TPC=True)
...
while (1):
    ...
    if Evaluation == False and Evaluation_slots == False:
        ...
        if read_id % 50== 0 and Visdom_flag == True  :
            ...
            plotter.plot('1lp_ds2', '1lp_ds2', '1lp_ds2', visdom_id, Model_infer.lossDisplay_p.cpu().detach().numpy())
