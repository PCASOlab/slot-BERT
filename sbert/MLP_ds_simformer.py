...
Output_root = Output_root+ "MLP_dynamic_slots_simformer" + selected_data + str(Data_percentage) + "/"
...
DEFAULT_CONFIG = "videosaur_m/configs/videosaur/ytvis3_MLP_ds_simformer.yml"
