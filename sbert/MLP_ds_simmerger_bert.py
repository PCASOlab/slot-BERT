...
Output_root = Output_root+ "0Merge_predict_bert" + dataset_tag + str(Data_percentage) + "/"
...
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),GPU_mode,num_gpus,Using_contrast=False,Using_SP_regu = False,Using_SP = True,Using_slot_bert=True,slot_ini= "rnn",gpu_selection=Gpu_selection,pooling="max",TPC=True)
