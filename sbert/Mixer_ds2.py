...
Output_root = Output_root+ "Mixer_dynamic_slots_2" + selected_data + str(Data_percentage) + "/"
...
DEFAULT_CONFIG = "videosaur_m/configs/videosaur/ytvis3_mixer_ds.yml"
...
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),GPU_mode,num_gpus,Using_contrast=False,Using_SP_regu = True,Using_slot_bert=False,slot_ini= "rnn",cTemp=1.1,gpu_selection=Gpu_selection,pooling="max",TPC=True)
