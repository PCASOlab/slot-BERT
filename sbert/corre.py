...
Output_root = Output_root+ "Obj_corr_MLP_BERT" + selected_data + str(Data_percentage) + "/"
...
DEFAULT_CONFIG = "videosaur_m/configs/videosaur/ytvis3_MLP_w_sim_MLP.yml"
...
Model_infer = model_infer_slot_att._Model_infer(parser.parse_args(),GPU_mode,num_gpus,Using_contrast=False,Using_slot_bert=False,slot_ini= "rnn",img_sim=True,gpu_selection=Gpu_selection,pooling="max",TPC=True)
